 ...
 */
// El color del cuadrito de cada sección, como los íconos de Ajustes.
const COLORES = {
  servicios: '#007AFF',
  equipo: '#0E9C9C',
  horarios: '#E09112',
          ...
          >
            ...
            <div className="px-4 pt-1 pb-5">
              <div className="flex items-center justify-between pl-1">
                <h2 className="ns-hoja__titulo">Más</h2>
                <button type="button" onClick={onCerrar} className="ui-icon-btn ns-hoja__cerrar" aria-label="Cerrar">
                  <svg className="w-[14px] h-[14px]" fill="none" stroke="currentColor" strokeWidth="3" viewBox="0 0 24 24" aria-hidden="true"><path d="M6 18L18 6M6 6l12 12" strokeLinecap="round" /></svg>
                </button>
              </div>
              ...
              <div className="ns-mas__lista mt-4">
                {secciones.map((s) => (
                  ...
                  >
                    <span className="ns-mas__icono" style={{ background: COLORES[s.id] || 'var(--ns-primary)' }} aria-hidden="true">
                    ...
                    {actual === s.id
                      ? <svg className="ns-mas__marca" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.6" aria-hidden="true"><path d="M5 13l4 4L19 7" strokeLinecap="round" strokeLinejoin="round" /></svg>
                      : <svg className="ns-mas__chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" aria-hidden="true"><path d="M9 5l7 7-7 7" strokeLinecap="round" strokeLinejoin="round" /></svg>}
                  </button>
                ))}
              </div>

              <div className="ns-mas__lista mt-6">
                {onCopiarLink && (
