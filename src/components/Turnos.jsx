      ...
      <div key={t.id} className="bg-white rounded-3xl p-5 md:p-6 shadow-[0_8px_30px_rgba(0,0,0,0.03)] border border-slate-100 flex items-center gap-4 md:gap-6 group hover:shadow-md transition-all">
         ...
         <div className="flex flex-col sm:flex-row gap-2 shrink-0">
            <button onClick={() => {
              ...
              window.open(`https://wa.me/${num}?text=${encodeURIComponent("Cita confirmada")}`, '_blank')
            }} className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-slate-50 text-slate-400 hover:bg-green-50 hover:text-green-500 flex items-center justify-center transition-all shadow-sm" title="Confirmar por WhatsApp">
