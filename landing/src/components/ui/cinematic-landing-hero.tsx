    ...
    <div ref={containerRef} className={cn("relative w-full h-[100dvh] overflow-hidden flex items-center justify-center bg-background text-foreground font-sans antialiased", className)} style={{ perspective: "1500px" }} {...props}>
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-full px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 w-full sm:w-auto px-4 sm:px-0">
          <a href="https://non-sistemas-reservas.vercel.app/login" target="_blank" rel="noopener noreferrer" className="btn-modern-light flex items-center justify-center gap-3 px-10 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
          ...
          <a href="https://non-sistemas-reservas.vercel.app/" target="_blank" rel="noopener noreferrer" className="btn-modern-dark flex items-center justify-center gap-3 px-10 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-background">
